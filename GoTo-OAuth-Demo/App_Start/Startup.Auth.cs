...
using Owin;
using Owin.Security.Providers.GoTo;
using GoTo_OAuth_Demo.Models;
...
namespace GoTo_OAuth_Demo
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            var GoToOptions = new GoToAuthenticationOptions {
                ClientId = "",
                ClientSecret = "",
                Provider = new GoToAuthenticationProvider 
                {
            ...
            app.UseGoToAuthentication(GoToOptions);
        }
    }
}